...
<body>
	<jsp:useBean id="bean" class="in.co.sunrays.bean.FacultyBean" scope="request"></jsp:useBean>
	<form action="<%=ORSView.FACULTY_CTL%>" method="post">
		<%@include file="Header.jsp"%>

		<%
			List clist = (List<CollegeBean>) request.getAttribute("CollegeList");
			List<CourseBean> crlist = (List<CourseBean>) request.getAttribute("CourseList");
		...
		<center>
			...
			<table>
				 ...
				 <tr>
					...
					<td><%=HTMLUtility.getList("collegeid", String.valueOf(bean.getCollege_id()), clist)%>
					</td>
...
<tr>
					...
					<td><%=HTMLUtility.getList("courseid", String.valueOf(bean.getCourse_id()), crlist)%>
					</td>
