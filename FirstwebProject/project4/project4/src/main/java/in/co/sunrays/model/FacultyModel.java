...
public class FacultyModel {
	...
	public static int Nextpk() throws ApplicationException {
	...
	public static void update(FacultyBean fb) throws Exception {
		// log.debug("Model update Started");
		Connection conn = null;
		int pk = 0;
		
		 CollegeModel cmodel = new CollegeModel(); CollegeBean cbean =
		  cmodel.findByPK(fb.getCollege_id()); String collegeName = cbean.getName();
		 
		  SubjectModel smodel = new SubjectModel(); SubjectBean sbean =
		 smodel.findByPK(fb.getSubject_id()); String subjectname =
		  sbean.getSubject_Name();
...
// log.debug("Faculty Model FindByPK method end");
	...
	public List serch(FacultyBean fb, int pageNo, int pageSize) throws ApplicationException {
		...
		if (fb.getMobile_No() != 0 && fb.getMobile_No() > 0) {
