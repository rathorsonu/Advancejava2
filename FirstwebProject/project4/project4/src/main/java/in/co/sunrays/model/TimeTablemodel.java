...
/**
	 ...
	 */public class TimeTablemodel {
		...
		public int add(TimetableBean tb) throws Exception {
		 ...
		 coumodel.findByPK(tb.getCourse_Id()); String courseName =
		  coubean.getCourse_Name();
		  
		 SubjectModel smodel = new SubjectModel(); SubjectBean sbean =
		 smodel.findByPK(tb.getSubject_Id()); String subjectName =
		 ...
		 */			
			try {
				...
				ps.setString(1,tb.getCourse_Name());
				ps.setInt(2, tb.getCourse_Id());
				ps.setString(3, tb.getSubject_Name());
