...
public class StudentModel {
	    ...
	    public long add(StudentBean bean) throws ApplicationException,
		  ...
		  CollegeModel cModel = new CollegeModel(); CollegeBean collegeBean =
		  ...
		  bean.setCollegeName(collegeBean.getName());
	       ...
	       // if (duplicateName != null) {
	        ...
	        try {
	            ...
	            pstmt.executeUpdate();
	            System.out.println("date insert2");
		 ...
		 */
	     ...
	     //   bean.setCollegeName(collegeBean.getName());
	        ...
	        try {
	           ...
	           throw new DuplicateRecordException("Exception in updating Student ");
	        } finally {
	            JDBCDataSource.closeConnection(conn);
	        }
